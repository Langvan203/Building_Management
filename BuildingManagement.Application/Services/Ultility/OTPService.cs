...
namespace BuildingManagement.Application.Services.Ultility
{
    public class OTPService : IOTPService
    {
        ...
        public OTPService(IOptions<OTPConfiguration> otpConfig, IEmailService emailService)
        {
        ...
        public async Task<string> GenerateAndSendOTPAsync(string email)
        {
            ...
            string htmlContent = htmlTemplate
                    .Replace("{{USERNAME}}", System.Net.WebUtility.HtmlEncode(email))
                    .Replace("{{OTP_CODE}}", System.Net.WebUtility.HtmlEncode(otp));
